...
import os
get_api = open("././envAPI/api.txt", 'r')
os.environ['OPENAI_API_KEY'] = get_api.readline()
...
if url:
    if ".xml" not in url:
        ...
        retriever = load_website(url, choose)
